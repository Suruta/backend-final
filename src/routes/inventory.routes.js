...
const { getInventories, addInventory, getInventoryById, updateInventory, deleteInventory, addAuctionFlash, deleteAuctionFlash, addAuctionBid, checkWinnerAuction } = require('../controllers/inventory.controllers');
...
routes.get('/:id/check-winner', checkWinnerAuction);
